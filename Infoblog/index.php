    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse fs-4" id="navbarNav">
        <ul class="navbar-nav ms-auto mb-lag-0 text-center">
          <li class="nav-item" >
            <a class="nav-link active" aria-current="page" href="index.php" style=" color: grey; ">Home <i class="fa-solid fa-house"></i></a>
          </li>
          
          <li class="nav-item">
            <a class="nav-link" href="adout.php">About <i class="fa-solid fa-circle-info"></i></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="admin_post/register-user.php">Register user</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-danger" href="admin_post/index.php">Login <i class="fa-solid fa-right-to-bracket"></i> </a>
          </li>
        </ul>
      </div>
    </div>
...
<section class="post-section">
      <div class="container text-center my-2">
          <h2 class="text text-light"data-aos="fade-up" data-aos-offset="230" >Latest Posts</h2>
    ...
    ?>
          ...
          <div class="post-box ms-3">
              <div class="card mb-3">
                  <div class="row g-0">
                      <div class="col-lg-3 col-md-4" data-aos="zoom-in" data-aos-offset="250">
